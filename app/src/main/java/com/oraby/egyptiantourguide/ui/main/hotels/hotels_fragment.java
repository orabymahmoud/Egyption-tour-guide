...
public class hotels_fragment extends DaggerFragment {

    @Inject
    public HotelsFragmentViewModel mViewModel;
    private ProgressBar progressBar;
    private SearchView searchView = null;
    private SearchView.OnQueryTextListener queryTextListener;
    private RecyclerViewVerticalListAdapter recyclerViewVerticalListAdapter;
    ...
    public static hotels_fragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.hotels_fragment_fragment, container, false);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    mToolbar.setTitle(getString(R.string.hotels));
        ...
        recyclerView = view.findViewById(R.id.hotels);
        progressBar = view.findViewById(R.id.Progress_hotels);

        mViewModel.gethotels();

        mViewModel.observepopularhotels().observe(((AppCompatActivity) getActivity()), new Observer<Resource<List<Hotel>>>() {
            @Override
                ...
                if(listResource != null)
                {
                    switch (listResource.status)
                    {
                        case SUCCESS:{
                            ...
                            recyclerViewVerticalListAdapter.setHotels(listResource.data);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(HotelsFragmentViewModel.class);
