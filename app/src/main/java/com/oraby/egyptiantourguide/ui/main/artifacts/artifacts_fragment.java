...
public class artifacts_fragment extends DaggerFragment {

    @Inject
    public ArtifactsFragmentViewModel mViewModel;
    ...
    public static artifacts_fragment newInstance() {
        return new artifacts_fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.artifacts_fragment_fragment, container, false);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    mToolbar.setTitle(getString(R.string.artifacts));
        ...
        recyclerView = view.findViewById(R.id.artifacts);
        progressBar = view.findViewById(R.id.Progress_artifacts);

        mViewModel.getartifacts();
                ...
                if(listResource != null)
                {
                    switch (listResource.status)
                    {
                        case SUCCESS:{
                            ...
                            recyclerViewVerticalListAdapter.setSuperArtifacts(listResource.data);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ArtifactsFragmentViewModel.class);
