...
public class RecyclerViewVerticalListAdapter extends RecyclerView.Adapter<RecyclerViewVerticalListAdapter.Hotelssholder>{
    ...
    @Override
    public Hotelssholder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflate the layout file
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_of_vertical, parent, false);
        Hotelssholder gvh = new Hotelssholder(view);
        return gvh;
    }

    @Override
    public void onBindViewHolder(Hotelssholder holder, final int position) {
    ...
    public class Hotelssholder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView txtview;
        public Hotelssholder(View view) {
            super(view);
